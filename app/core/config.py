...
ROUTE_OUTPUTS_DIR = DATA_DIR / "route_outputs"
ROUTE_OUTPUTS_SHELTERS_DIR = DATA_DIR / "route_outputs_with_shelters"
ROUTE_META_DIR = DATA_DIR / "outputs" / "route_meta"
ROUTE_GEOM_DIR = DATA_DIR / "outputs" / "route_geom"
